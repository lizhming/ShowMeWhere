...
class Language extends Component {
  ...
  _renderRow(data) {
    ...
    var translate = <Text style={styles.listTranslation}>{data.translation}</Text>;
    if(data.english == 'Bengali'||data.english == 'Urdu'||data.english == 'Arabic'){
      translate = <Text style={styles.specialTranslation}>{data.translation}</Text>;
    }
    return (
      <View>
        <TouchableOpacity
